    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="body">
                ...
                <form class="validate-form" action="{{ route('admin.blogs.update',$blog->id) }}" method="POST" novalidate enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="clearfix row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify" data-default-file="{{$blog->image_path}}" required name="img" class="form-control" >
                                @error('img')
                                    <p class="help text-danger">{{ $message }}</p>
                                @enderror
                            </div>
